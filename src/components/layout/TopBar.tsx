...
export function TopBar() {
  ...
  return (
    <header
      ...
      role="banner"
    >
      {/* Logo — h1 está em cada página; aqui é identidade da marca */}
      <Link to="/" className="flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-coral rounded" aria-label="Chefinho Fit — página inicial">
          ...
          {menuOpen && (
            <>
              ...
              <nav
                role="menu"
                aria-label="Opções"
                className="absolute right-0 top-9 z-20 bg-white border border-gray-200 rounded-xl shadow-lg py-1 min-w-[180px]"
              >
                <Link
                  to="/privacidade"
                  role="menuitem"
        ...
        >
          <div className="bg-white rounded-2xl p-5 w-full max-w-sm flex flex-col gap-4 shadow-xl">
            ...
            <p className="font-body text-sm text-gray-600">
              Isso apagará o perfil da criança, o cardápio, pontos e todo o histórico salvos neste dispositivo. Esta ação é irreversível.
            </p>
